        ...
        <div className="flex flex-col gap-4 p-5 bg-white border border-slate-200 rounded-xl shadow-sm">
            ...
            <div className="flex flex-col gap-1.5">
                ...
                <textarea
                    ...
                    rows={10}
                    className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary-400 focus:border-transparent outline-none transition-all text-sm min-h-[200px] resize-none"
                />
            </div>

            <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-100">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider self-center mr-2">Variables:</span>
                {['name', 'company', 'title'].map((variable) => (
                    <button
                        key={variable}
                        type="button"
